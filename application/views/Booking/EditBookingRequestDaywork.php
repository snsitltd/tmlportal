        ...
        <div class="row"> 
            <div class="col-md-12"> 
                <div class="box box-primary">
                    ...
                    <form id="EditBooking" name="EditBooking"  action="<?php echo base_url('EditBookingRequestDaywork/'.$BookingRequest['BookingRequestID']); ?>"  method="post" role="form" > 
						...
						<div class="col-md-6">    
							...
							<?php //$JT = explode(':',$BookingRequest['JourneyTime']); 
									//$JourneyHour = $JT[0]; $JourneyMin = $JT[1];
							?>
							 <div class="row">
								 <div class="col-md-6">
									<div class="form-group">
                                        <label for="JourneyTime"> Journey Time </label>
                                        <input type="text" class="form-control time-hhmm " id="JourneyTime"  value="<?php echo $BookingRequest['JourneyTime']; ?>" name="JourneyTime"  > 
										<em>Note: Format 02:00  </em>
                                    </div>  
                                    <!--<div class="form-group">
                                        <label for="JourneyTime"> Journey Time (Hour)  </label>
                                        <input type="number" class="form-control " id="JourneyHour"   value="<?php //echo $JourneyHour; ?>" name="JourneyHour"  max="24" min="0" maxlength="2"  > 
                                    </div>  -->
                                </div>  
								<!--<div class="col-md-3">
                                    <div class="form-group">
                                        <label for="JourneyTime"> Journey Time (Minute) </label> 
										<input type="number" class="form-control " id="JourneyMin"   value="<?php //echo $JourneyMin; ?>" name="JourneyMin"    maxlength="2" max="60" min="0"   >
                                    </div>
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control time-hhmm " id="StartTime"  value="<?php echo $BookingRequest['StartTime']; ?>"  name="StartTime" >
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control time-hhmm " id="FinishTime"  value="<?php echo $BookingRequest['FinishTime']; ?>"  name="FinishTime" >
										<em>Note: Format 08:00  </em>	
							  ...
							  <thead>
								...
								<tr id="<?php echo $record->BookingID; ?>"> 
										...
										<td>
											...
											<input type="hidden" id="MaterialName<?php echo $record->BookingID; ?>"  name="MaterialName[<?php echo $record->BookingID; ?>]" value="Daywork"  > 
										</td> 
										<td>
											<select class="form-control  " id="DayWorkType<?php echo $record->BookingID; ?>" name="DayWorkType[<?php echo $record->BookingID; ?>]"  <?php if($record->TotalLoadAllocated>0){ ?> disabled <?php } ?>  data-live-search="true" >  
												<option value="1" <?php if($record->DayWorkType ==1){ ?> selected <?php } ?>  >Day</option> 
												<option value="2" <?php if($record->DayWorkType ==2){ ?> selected <?php } ?>  >Night</option> 
												<option value="3" <?php if($record->DayWorkType ==3){ ?> selected <?php } ?>  >Hour</option> 
                                        </select>   
										</td> 
										<td>
