			  ...
			  <thead>
				...
				<tr class="<?php echo $cls1; ?>">
					...
					<td class="text-center">
						...
						<a class="btn btn-sm btn-danger DeleteBooking"  data-BookingID="<?php echo $record->BookingID; ?>"  data-BookingDateID="<?php echo $record->BookingDateID; ?>"   href="#" title="Delete"><i class="fa fa-trash"></i></a> 
