...
<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i> Archived Loads/Lorry Booking Request Allocation </h1>    </section> 
			...
			<div class="col-md-12">
				<div class="nav-tabs-custom"> 
					<ul class="nav nav-tabs"> 
						<li  class="active" ><a href="#Finished" data-toggle="tab" aria-expanded="false">Archived Finished </a></li>    
						<a class="btn btn-success" href="<?php echo base_url('AllocateBookingRequest'); ?>" style="float:right;margin: 6px "> Current Allocation</a>						
					</ul> 
							...
							<div class="col-xs-12">
								<div class="box">
									<div class="box-header">
										<h3 class="box-title"> Archived Finished Loads/Lorry Booking Allocation </h3>   
									</div>
...
<script type="text/javascript" language="javascript" >
	...
	$(document).ready(function() { 
		...
		var dataTable = $('#ticket-grid4').DataTable({
			...
			"ajax":{
				url : "<?php echo site_url('AjaxAllocatedBookingsRequestArchived') ?>", // json datasource
