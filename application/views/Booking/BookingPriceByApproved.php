<div class="content-wrapper">
	<section class="content-header">
		<h1> <i class="fa fa-users"></i> Booking Request ( Price By ) </h1>
	</section>
			...
			<div class="col-md-12">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li class=""><a href="<?php echo base_url('BookingPriceByPending'); ?>" aria-expanded="false">Pending</a></li>
						<li class="active"><a href="#Approved" data-toggle="tab" aria-expanded="true">Approved </a></li>
								...
								<div class="col-xs-12">
									<div class="box">
										<div class="box-header">
											<h3 class="box-title">Approved Booking Request Price By List</h3>
										</div>
										<div class="box-body">
...
<script type="text/javascript" language="javascript">
	...
	var GetTableMetaApiEndpoint = 'BookingPriceByApprovedTableMeta'; //Endpoint returning Table Metadata 
	var GetTableDataApiEndpoint = 'BookingPriceByApprovedAJAX'; //Endpoint processing and return Table Data
