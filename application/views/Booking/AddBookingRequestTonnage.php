...
<div class="content-wrapper"> 
    <section class="content-header"><h1><i class="fa fa-users"></i> Add Booking (Tonnage)  </h1>
             ...
             <div class="col-md-12">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs"> 
						...
						<li class="active"><a href="#AddBooking2"  data-toggle="tab" aria-expanded="true">Add Tonnage Booking</a></li>         
            ...
            <div class="col-md-12">
              <!-- general form elements --> 
                <div class="box box-primary">
                    <div class="box-header"> <h3 class="box-title">Tonnage Booking Information</h3> </div>  
					<div id="result"></div>  
                    <?php $this->load->helper("form"); ?>
                    <form id="AddBooking" name="AddBooking"  action="<?php echo base_url('AddBookingRequestTonnage'); ?>"  method="post" role="form" > 
                        <div class="box-body">
                        <div class="col-md-6">     
                            <div class="row">
                                <div class="col-md-6">
							...
							<div class="row">  	
							  ...
							  <thead>
								...
								<tr id="1"> 
										...
										<td>
											<input type="text" class="form-control" id="SICCode1" data-BID="1" style="text-align:right"  required="required"  maxlength="6" name="SICCode[]" value="" >  
											<div ></div>	
										</td>
										
										<td>
											<input type="number" class="form-control required TotalTon"  style="text-align:right"  required="required" min="1" id="TotalTon1" data-BID="1" name="TotalTon[]" value="1" maxlength="99999" >  
										</td>
										<td>
											<input type="number" class="form-control required TonPerLoad" min="1" style="text-align:right"  required="required"  id="TonPerLoad1" data-BID="1" name="TonPerLoad[]" maxlength="99999"  value="1" >  
										</td>
										<td>
										...
										<td>
											<select class="form-control LorryType" id="LorryType1" name="LorryType[]"  required="required"   data-live-search="true" >  
										...
										<td><input type="text" class="form-control Loads" id="Loads1" readonly style="text-align:right"  name="Loads[]"  >  </td>
										<td>
										...
										<td>
											<input type="number" class="form-control Price" id="Price1"  style="text-align:right"    data-BID="1" name="Price[]" value="" > 
...
<script type="text/javascript" language="javascript" > 	 
	$(document).ready(function(){ 
		...
		$('#addBtn').on('click', function () {  
			...
			Append += '<td><select class="form-control LorryType" id="LorryType'+rowIdx+'" name="LorryType[]"  data-live-search="true" ></select></td>'; 
