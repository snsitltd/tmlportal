...
<form id="MaterialUpdate" name="MaterialUpdate" action="<?php echo base_url('MaterialUpdateDelivery/'.$LoadID); ?>" method="post" role="form" >    
...
<div class="row">  
	<div class="col-md-12"> 
		<div>
			...
			<?php if(!empty($MaterialRecords)){ foreach ($MaterialRecords as $rl){ if($MaterialID!=$rl->MaterialID){ if($rl->Status == $status){ ?>
