...
<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i> Archived Approved Booking Request <small>Add, Edit, Delete</small>   </h1>    </section> 
...
function initializeDataTable1() {
    ...
    table = $('#dtexample1').DataTable({
		...
		createdRow: function (row, data, dataIndex) {  
				...
				var btype = '';   var del = '';var edi = '';var LorryType = '';
