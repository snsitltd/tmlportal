...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-users"></i> Booking Request Haulage Load <small> Set Stage to Finish</small></h1>
	</section>
     ...
     <section class="content"> 
		...
		<div class="box box-primary">
              ...
              <?php $this->load->helper("form"); ?>
                    <form role="form" id="AddStage" action="<?php echo base_url('BookingRequestHaulageFinish/'.$LoadInfo->LoadID) ?>" method="post" >
                        ...
                        <div class="box-body">
							...
							<div class="row"> 
                                ...
                                <div class="col-md-12">                                
                                    <div class="form-group">
                                        <label for="fname">Produced By : </label>  
							...
							<div class="row"> 
                                ...
                                <div class="col-md-12">                                
                                    <div class="form-group">
										...
										<input type="text" class="form-control " id="CustomerName1" value="<?php echo set_value('CustomerName1'); ?>" name="CustomerName1">
                                    </div> 
                                </div> 
                            </div>
							<!--							
							...
							<input type='hidden' name="Signature1" id="Signature1" required value="" >	
							<div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group">
