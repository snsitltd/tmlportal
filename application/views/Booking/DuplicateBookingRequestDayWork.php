        ...
        <div class="row"> 
            <div class="col-md-12"> 
                <div class="box box-primary">
                    ...
                    <form id="AddBooking" name="AddBooking"  action="<?php echo base_url('DuplicateBookingRequestDayWork/'.$BookingRequest['BookingRequestID']); ?>"  method="post" role="form" > 
							  ...
							  <thead>
								...
								<tr id="<?php echo $i; ?>"> 
										...
										<td>
											...
											<input type="hidden" id="MaterialName<?php echo $i; ?>"  name="MaterialName[]" value="Daywork"  > 
										</td> 
										<td>
											<select class="form-control  " id="DayWorkType<?php echo $i; ?>" name="DayWorkType[]"    data-live-search="true" >  
										...
										<td>
											<input type="text" class="form-control" id="SICCode<?php echo $i; ?>"  style="text-align:right"      name="SICCode[]" readonly value="<?php echo $record->SICCode; ?>" >  
										</td> 
										...
										<td>
                                            ...
                                            <?php for($j=1;$j<100;$j++){ ?>
                                                    <option value="<?php echo $j; ?>" <?php if($j == $record->Loads) { ?> selected <?php } ?> ><?php echo $j; ?></option>
                                            <?php } ?>
											</select>    
										</td>
										<td>
											<div class="input-group date">
												...
												<input type="text" class="form-control required BookingDateTime"  required data-BID='<?php echo $i; ?>' id="BookingDateTime<?php echo $i; ?>" autocomplete="off"  name="BookingDateTime[]" maxlength="65">
											</div>  
											<div ></div> 										
										</td>
										<td>
