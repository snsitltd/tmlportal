...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-users"></i> Booking Request DayWork Load <small> Set Stage to Finish</small></h1>
	</section>
     ...
     <section class="content"> 
		...
		<div class="box box-primary">
              ...
              <?php $this->load->helper("form"); ?>
                    <form role="form" id="AddStage" action="<?php echo base_url('BookingRequestDayworkFinish/'.$LoadInfo->LoadID) ?>" method="post" >
							...
							<!-- <div class="row">
								<div class="col-md-6">  
									<div class="form-group">
										...
										<div class="input-group date">
											...
											<input type="text" class="form-control required" id="SiteInDateTime" value="<?php //echo date("d-m-Y H:i:s");; ?>" name="SiteInDateTime" maxlength="65">
										</div>
									</div> 
								</div> 
                                ...
                                <div class="col-md-6">  
									<div class="form-group">
										...
										<div class="input-group date">
											<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
											<input type="text" class="form-control required" id="SiteOutDateTime" value="<?php //echo date("d-m-Y H:i:s");; ?>" name="SiteOutDateTime" maxlength="65">
										</div>
									</div> 
								</div> 
                            </div>     --> 
