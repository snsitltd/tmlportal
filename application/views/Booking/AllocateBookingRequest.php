			  ...
			  <thead>
				...
				<tr class="<?php echo $cls1; ?>">
					...
					<td class="text-center">
						...
						<a class="btn btn-sm  btn-info Allocate" herf="#" data-BookingRequestID="<?php echo $record->BookingRequestID; ?>"  data-BookingNo="<?php echo $record->BookingID; ?>"  data-PendingLoad="<?php echo $pLoads; ?>"  data-LoadType="<?php echo $record->LoadType; ?>" data-BookingDateID="<?php echo $record->BookingDateID; ?>"  title="Allocate Booking"><i class="fa fa-check"></i> </a>
						<a class="btn btn-sm btn-danger DeleteBooking"  data-BookingID="<?php echo $record->BookingID; ?>"  data-BookingDateID="<?php echo $record->BookingDateID; ?>"   href="#" title="Cancel Allocation"><i class="fa fa-times" aria-hidden="true"></i></a> 
