  ...
  <ul class="timeline">
	...
	<li>
	  ...
	  <div class="timeline-item">
		...
		had Allocated a Load / Lorry to <a href="<?php echo base_url('viewDriver/'.$Loads[0]->DriverID); ?>" ><?php echo $DriverName; ?> <?php if($Loads[0]->DriverMobile!=""){ echo "( ".$Loads[0]->DriverMobile." )"; } ?> </a> </h3> 
	...
	<li>
	  ...
	  <div class="timeline-item">
		...
		<h3 class="timeline-header no-border"><a href="<?php echo base_url('viewDriver/'.$Loads[0]->DriverID); ?>" ><?php echo $DriverName; ?> <?php if($Loads[0]->DriverMobile!=""){ echo "( ".$Loads[0]->DriverMobile." )"; } ?> </a> has Accepted Load / Lorry Request.</h3>
		<div class="timeline-body">
	...
	<?php if($Loads[0]->SiteInDateTime != '00/00/0000 00:00:00'){ ?>
		...
		<li>
		  <i class="fa fa-user bg-aqua"></i> 
		  <div class="timeline-item"> 
			<h3 class="timeline-header no-border"> <a href="<?php echo base_url('viewDriver/'.$Loads[0]->DriverID); ?>" ><?php echo $DriverName; ?> <?php if($Loads[0]->DriverMobile!=""){ echo "( ".$Loads[0]->DriverMobile." )"; } ?> </a> 
	...
	<?php if($Loads[0]->SiteOutDateTime != '00/00/0000 00:00:00'){ ?>
		...
		<li>
		  ...
		  <div class="timeline-item">  
			<h3 class="timeline-header"><a href="<?php echo base_url('viewDriver/'.$Loads[0]->DriverID); ?>" ><?php echo $DriverName; ?> <?php if($Loads[0]->DriverMobile!=""){ echo "( ".$Loads[0]->DriverMobile." )"; } ?> </a>  uploaded photos</h3> 
			<div class="timeline-body">
	...
	<li>
	  ...
	  <div class="timeline-item"> 
		<h3 class="timeline-header no-border"> <a href="<?php echo base_url('viewDriver/'.$Loads[0]->DriverID); ?>" ><?php echo $DriverName; ?> <?php if($Loads[0]->DriverMobile!=""){ echo "( ".$Loads[0]->DriverMobile." )"; } ?> </a> 
		has been Left From <b><?php echo $Loads[0]->OpportunityName; ?> <?php //echo $Loads[0]->TipName; ?>.</b> </h3> 
	  </div>
	</li>	
	<?php } ?>
	<?php } ?>
