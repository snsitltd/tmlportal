        ...
        <div class="row"> 
            <div class="col-md-12"> 
                <div class="box box-primary">
                    ...
                    <form id="EditBooking" name="EditBooking"  action="<?php echo base_url('EditBookingRequestHaulage/'.$BookingRequest['BookingRequestID']); ?>"  method="post" role="form" > 
							...
							<div class="row">  	
							  ...
							  <thead>
								...
								<tr id="<?php echo $record->BookingID; ?>"> 
										<td>
										<input type="hidden" id="BookingID<?php echo $record->BookingID; ?>"  name="BookingID[<?php echo $record->BookingID; ?>]" value="<?php echo $record->BookingID; ?>"  > 
										<input type="hidden" id="TotalLoadAllocated<?php echo $record->BookingID; ?>"  name="TotalLoadAllocated[<?php echo $record->BookingID; ?>]" value="<?php echo $record->TotalLoadAllocated; ?>"  >  
										<input type="hidden" id="BookingType<?php echo $record->BookingID; ?>" data-BID="<?php echo $record->BookingID; ?>"  name="BookingType[<?php echo $record->BookingID; ?>]"  value = '4'  > 
										<input type="hidden" id="DescriptionofMaterial<?php echo $record->BookingID; ?>" data-BID="<?php echo $record->BookingID; ?>"   name="DescriptionofMaterial[<?php echo $record->BookingID; ?>]"  value = '495'  > 
										<input type="hidden" id="MaterialName<?php echo $record->BookingID; ?>"  name="MaterialName[<?php echo $record->BookingID; ?>]" value = 'Haulage'  >  	
										<input type="hidden" id="TipID<?php echo $record->BookingID; ?>" data-BID="<?php echo $record->BookingID; ?>"   name="TipID[<?php echo $record->BookingID; ?>]" value="<?php echo $record->TipID; ?>" >     
										
										<input type="text" readonly id="TipName<?php echo $record->BookingID; ?>" data-BID="<?php echo $record->BookingID; ?>" class="form-control  "  name="TipName[<?php echo $record->BookingID; ?>]" value="<?php echo $record->TipName; ?>" required="required" placeholder="TipName"  <?php if($record->TotalLoadAllocated>0){ ?> readonly <?php } ?>  >     
										
										<!--<input type="text" id="TStreet1<?php //echo $record->BookingID; ?>" data-BID="<?php //echo $record->BookingID; ?>" style="width:140px;"   name="TStreet1[<?php //echo $record->BookingID; ?>]" value="<?php //echo $record->Street1; ?>" required="required" placeholder="Street1"  <?php ///if($record->TotalLoadAllocated>0){ ?> readonly <?php //} ?>  >     
										<input type="text" id="TStreet2<?php //echo $record->BookingID; ?>"  data-BID="<?php //echo $record->BookingID; ?>"  style="width:140px;"    name="TStreet2[<?php //echo $record->BookingID; ?>]" value="<?php //echo $record->Street1; ?>"   placeholder="Street2"   <?php //if($record->TotalLoadAllocated>0){ ?> readonly <?php //} ?>  >     
										<input type="text" id="TTown<?php //echo $record->BookingID; ?>"  data-BID="<?php //echo $record->BookingID; ?>"  style="width:100px;" name="TTown[<?php //echo $record->BookingID; ?>]" value="<?php //echo $record->Town; ?>" required="required"  placeholder="Town"   <?php //if($record->TotalLoadAllocated>0){ ?> readonly <?php //} ?> >     
										<input type="text" id="TCounty<?php //echo $record->BookingID; ?>"  data-BID="<?php //echo $record->BookingID; ?>"  style="width:100px;" name="TCounty[<?php //echo $record->BookingID; ?>]" value="<?php //echo $record->County; ?>" required="required"  placeholder="County"   <?php //if($record->TotalLoadAllocated>0){ ?> readonly <?php //} ?> >     
										<input type="text" id="TPostCode<?php //echo $record->BookingID; ?>"  data-BID="<?php // echo $record->BookingID; ?>"  style="width:100px;" name="TPostCode[<?php //echo $record->BookingID; ?>]" value="<?php //echo $record->PostCode; ?>" required="required"  placeholder="PostCode"   <?php //if($record->TotalLoadAllocated>0){ ?> readonly <?php // } ?> >     
										-->
										<div ></div> 
										
										</td>    
										<td>
											<input type="text" class="form-control" id="SICCode<?php echo $record->BookingID; ?>"  style="text-align:right"   <?php if($record->TotalLoadAllocated>0){ ?> readonly <?php } ?>  data-BID="<?php echo $record->BookingID; ?>" name="SICCode[<?php echo $record->BookingID; ?>]" readonly value="<?php echo $record->SICCode; ?>" >  
										</td> 
