        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url('AddBookingRequest'); ?>"><i class="fa fa-plus"></i> Add Booking</a> 
                </div> 
            </div>
        </div>
        <div class="row">
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#ticket-grid').DataTable({
			...
			"order": [[ 10, "asc" ] ,[ 1, "desc" ]  ], 
			"columns": [
				{ "data": "BookingRequestID" , "name": "BookingRequestID" , "data-sort": "BookingRequestID" },
				{ "data": "BookingDate" , "name": "BookingDate" , "data-sort": "BookingDate1" },				  
			...
			"ajax":{
				url : "<?php echo site_url('AjaxBookingsRequest') ?>", // json datasource
			...
			createdRow: function (row, data, dataIndex) {  
				...
				if(data["BookingDateStatus"] == '0'){ status = '<div id="ap'+data["BookingDateID"]+'" ><a class="btn btn-danger ApproveBooking" herf="#" data-BookingDateID="'+data["BookingDateID"]+'" data-Price="'+data["Price"]+'" title="Click Here To Approve Booking"><i class="glyphicon glyphicon-ok"></i></a></div>' ; 	}
				if(data["TotalLoadAllocated"] == '0'){  
					del = '<a class="btn btn-sm btn-danger deleteTicket" href="#" data-BookingDateID="'+data["BookingDateID"]+'" title="Delete"><i class="fa fa-trash"></i></a>' ;	 
					edi = '<a class="btn btn-sm btn-info" href="'+baseURL+'EditBooking/'+data["BookingDateID"]+'" title="Edit Booking"><i class="fa fa-pencil"></i></a>' ;
				}
