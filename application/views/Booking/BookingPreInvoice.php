...
<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i> All Booking PreInvoice </h1>    </section> 
			...
			<div class="col-md-12">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs"> 
						<li class=""><a href="<?php echo base_url('MyBookingPreInvoice'); ?>"  aria-expanded="false">My PreInvoices</a></li>         
						<li class="active"><a href="#all" data-toggle="tab" aria-expanded="true">All PreInvoices </a></li> 
					</ul> 
							...
							<div class="row">
								...
								<div class="box">
									<div class="box-header">
										<h3 class="box-title">All Booking PreInvoice  </h3>
									</div> 
									<div class="box-body" >
...
<script type="text/javascript" language="javascript" >
	...
	$(document).ready(function() { 
		...
		var dataTable = $('#PreInvoice').DataTable({
			...
			"ajax":{
				url : "<?php echo site_url('AjaxPreInvoiceList') ?>", // json datasource
