	...
	<div class="col-md-6" > 
		<div class="form-group">
			...
			<div class="input-group date">
				...
				<input type="text" class="form-control" id="TipTicketDate" required  readonly name="TipTicketDate" maxlength="65">
			</div>
		</div> 
	</div>	   
	<div class="col-md-12">                                
...
<div class="row">   
	<div class="col-md-12">
		<button class="btn btn-sm  btn-info CreateDeliveryTicket"  data-BookingRequestID="<?php echo $BookingRequestID; ?>" title="Create Ticket"><i class="fa fa-check"></i> Create Ticket </button>  
	</div>   
</div> 
</div> 
