			...
			<div class="col-md-12">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li ><a href="<?php echo base_url('BookingRequest'); ?>" aria-expanded="true">Pending </a></li> 
						<li class="active"><a href="#Approved" data-toggle="tab" aria-expanded="false">Approved</a></li>  
...
var GetTableDataApiEndpoint1 = 'AjaxBookingsRequest2';//Endpoint processing and return Table Data
...
function initializeDataTable1() {
    ...
    table = $('#dtexample1').DataTable({
		...
		createdRow: function (row, data, dataIndex) {  
				...
				var btype = '';   var del = '';var edi = ''; var Dup = ''; var prc_app = ''; var LorryType = '';
				...
				if(data["LoadType"] == 1){ $(row).find("td:eq(8)").html('Loads'); NoLoads = data["Loads"];  }else{  $(row).find("td:eq(8)").html('TurnAround');  NoLoads = data["Loads"];  }
				...
				//if(data["TotalLoadAllocated"] == '0'){  
					...
					if(data["TonBook"] == 1){		  
						...
						Dup = '<a class="btn btn-sm btn-warning" href="'+baseURL+'DuplicateBookingRequestTonnage/'+data["BookingRequestID"]+'" title="Duplicate Booking Request"><i class="fa fa-copy"></i></a>' ;
						...
						if(data["BookingType"] ==3){
							...
							Dup = '<a class="btn btn-sm btn-warning" href="'+baseURL+'DuplicateBookingRequestDayWork/'+data["BookingRequestID"]+'" title="Duplicate Booking Request"><i class="fa fa-copy"></i></a>' ;
				
						}else if(data["BookingType"] ==4){
							edi = '<a class="btn btn-sm btn-info" href="'+baseURL+'EditBookingRequestHaulage/'+data["BookingRequestID"]+'" title="Edit Booking Request"><i class="fa fa-pencil"></i></a>' ;
							Dup = '<a class="btn btn-sm btn-warning" href="'+baseURL+'DuplicateBookingRequestHaulage/'+data["BookingRequestID"]+'" title="Duplicate Booking Request"><i class="fa fa-copy"></i></a>' ;
						}else{	
							...
							Dup = '<a class="btn btn-sm btn-warning" href="'+baseURL+'DuplicateBookingRequest/'+data["BookingRequestID"]+'" title="Duplicate Booking Request"><i class="fa fa-copy"></i></a>' ;
						}
				...
				$(row).find("td:eq(-1)").html(edi+' '+del+' '+Dup+' '+log ); 
