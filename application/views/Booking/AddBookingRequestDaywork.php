...
<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="fa fa-users"></i> Add DayWork Booking </h1>
	</section>
								...
								<div class="col-md-12">
									...
									<div class="box box-primary">
										...
										<form id="AddBooking" name="AddBooking"
											action="<?php echo base_url('AddBookingRequestDaywork'); ?>"
																...
																<select class="form-control required County" id="County"
																	...
																	if (!empty($county)) {
																		foreach ($county as $rl) { ?>
																			<option value="<?php echo $rl->County ?>" <?php if ($rl->County == set_value('County')) { ?>
																					selected <?php } ?>><?php echo $rl->County ?>
																			</option>
																			<?php
																		}
																	}
													...
													<div class="row">
														<div class="col-md-6">
															<div class="form-group">
																...
																<input type="text" class="form-control time-hhmm "
																	id="JourneyTime" value="0200" name="JourneyTime">
											...
											<label> <input type="checkbox" name="OpenPO" value="1" id="OpenPO"  > Open PO </label>
														...
														<div class="col-md-3">
															<div class="form-group">
																...
																<input type="text" class="form-control time-hhmm "
																	id="StartTime" value="08:00" name="StartTime">
														...
														<div class="col-md-3">
															<div class="form-group">
																...
																<input type="text" class="form-control time-hhmm "
																	id="FinishTime" value="06:00" name="FinishTime">
																<em>Note: Format 08:00 </em>
																...
																<tr id="1">
																	...
																	<td>
																		...
																		<input type="hidden" id="MaterialName1"
																			name="MaterialName[]" value='Daywork'>
																	</td>
																	<td>
																		<select class="form-control " id="DayWorkType1"
																			name="DayWorkType[]" required="required">
																	...
																	<td>
																		<input type="text" class="form-control"
																			...
																			readonly maxlength="6" name="SICCode[]"
																			value="38.11">
																		<div></div>
																	</td>
