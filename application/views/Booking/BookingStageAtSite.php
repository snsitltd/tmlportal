<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-users"></i> Booking Load <small> Set Stage to Reach / At Site</small></h1>
	</section>
     ...
     <section class="content"> 
		...
		<div class="box box-primary">
              ...
              <?php $this->load->helper("form"); ?>
                    <form role="form" id="AddStage" action="<?php echo base_url('BookingStageAtSite/'.$LoadInfo->LoadID) ?>" method="post" >
