        ...
        <div class="row"> 
            <div class="col-md-12"> 
                <div class="box box-primary">
                    ...
                    <form id="AddBooking" name="AddBooking"  action="<?php echo base_url('DuplicateBookingRequest/'.$BookingRequest['BookingRequestID']); ?>"  method="post" role="form" > 
							...
							<div class="row">  	
							  ...
							  <thead>
								...
								<tr id="<?php echo $i; ?>"> 
										...
										<td>
											<input type="number" class="form-control Price" id="Price<?php echo $i; ?>"  style="text-align:right"    name="Price[]" value="<?php echo $record->Price; ?>" value="<?php echo $record->Price; ?>"> 
