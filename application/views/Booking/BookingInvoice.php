<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i> All Booking Invoice </h1>    </section> 
			...
			<div class="col-md-12">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">  
						<li ><a href="<?php echo base_url('MyBookingInvoice'); ?>"  aria-expanded="false" >My Invoices</a></li>         
						<li class="active"><a href="#" >All Invoices </a></li>
					</ul> 
							...
							<div class="row">
								...
								<div class="box">
									<div class="box-header">
										<h3 class="box-title">All Booking Invoice  </h3>
									</div> 
									<div class="box-body" >
...
<script type="text/javascript" language="javascript" >
	...
	$(document).ready(function() { 
		...
		var dataTable = $('#Invoice').DataTable({
			...
			"ajax":{
				url : "<?php echo site_url('AjaxInvoiceList') ?>", // json datasource
