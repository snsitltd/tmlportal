<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i> All  Ready to Booking Invoice </h1>    </section> 
			...
			<div class="col-md-12">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs"> 
						<li ><a href="<?php echo base_url('MyReadyBookingInvoice'); ?>"   aria-expanded="true" >My Ready to Invoices</a></li>         
						<li class="active"><a href="#"  aria-expanded="false" >All Ready to Invoices </a></li>
					</ul>  
							...
							<div class="row">
								...
								<div class="box">
									<div class="box-header">
										<h3 class="box-title">All Ready to Booking Invoice  </h3>
									</div> 
									<div class="box-body" >
...
<script type="text/javascript" language="javascript" >
	...
	$(document).ready(function() { 
		...
		var dataTable = $('#Invoice').DataTable({
			...
			"ajax":{
				url : "<?php echo site_url('AjaxReadyInvoiceList') ?>", // json datasource
