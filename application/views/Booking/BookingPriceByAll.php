								...
								<div class="col-xs-12">
									<div class="box">
										<div class="box-header">
											<h3 class="box-title">All Booking Request Price By  List</h3>
										</div> 
										<div class="box-body">
...
var GetTableMetaApiEndpoint = 'BookingPriceByAllTableMeta';//Endpoint returning Table Metadata 
var GetTableDataApiEndpoint = 'BookingPriceByAllAJAX';//Endpoint processing and return Table Data
