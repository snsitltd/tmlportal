...
<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i>Conveyance Tickets </h1>    </section> 
	...
	function initializeDataTable() {
		...
		table = $('#dtexample').DataTable({
							...
							exportOptions: {
							  format: {
								header: function ( data, columnIdx ) {
								  ...
								  if(columnIdx == 0){ data = 'Conveyance No '; } 
								  //if(columnIdx == 1){ data = 'Type'; } 
								  if(columnIdx == 1){ data = 'DateTime'; } 
								  if(columnIdx == 2){ data = 'Company Name'; } 
								  if(columnIdx == 3){ data = 'Site Address'; } 
								  if(columnIdx == 4){ data = 'Material'; } 
								  if(columnIdx == 5){ data = 'Driver Name'; } 
								  if(columnIdx == 6){ data = 'Veh.No'; }  
								  if(columnIdx == 7){ data = 'Status'; } 
			...
			createdRow: function (row, data, dataIndex) {  
				...
				if(data["Status"]=="4"){ Status = '<span class="label label-success"> Finished </span>'; } 
				if(data["Status"]=="5"){ Status = '<span class="label label-danger"> Cancelled </span>'; } 
				if(data["Status"]=="6"){ Status = '<span class="label label-warning"> Wasted </span>'; } 
