<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i>Archived Finished Loads/Lorry List </h1>    </section> 
			...
			<div class="col-md-12">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#" aria-expanded="true">Archived Finished </a></li>  
						<a class="btn btn-success" href="<?php echo base_url('RequestLoads'); ?>" style="float:right;margin: 6px "> Running Loads</a>
					</ul> 
							...
							<div class="col-xs-12">
								<div class="box">
									<div class="box-header">
										<h3 class="box-title">Archived Finished Loads/Lorry List</h3>
									</div> 
									<div class="box-body">
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		...
		var dataTable1 = $('#ticket-grid1').DataTable({
			...
			"ajax":{
				url : "<?php echo site_url('AjaxRequestLoadsArchived') ?>", // json datasource
