        ...
        <div class="row"> 
            <div class="col-md-12"> 
                <div class="box box-primary">
                    ...
                    <form id="EditBooking" name="EditBooking"  action="<?php echo base_url('EditBookingRequestTonnage/'.$BookingRequest['BookingRequestID']); ?>"  method="post" role="form" > 
							...
							<div class="row">  	
							  ...
							  <thead>
								...
								<tr id="<?php echo $record->BookingID; ?>"> 
										...
										<td>
											<input type="number" class="form-control required TotalTon"  style="text-align:right"  min="1" id="TotalTon<?php echo $record->BookingID; ?>" data-BID="<?php echo $record->BookingID; ?>" name="TotalTon[<?php echo $record->BookingID; ?>]" value="<?php echo $record->TotalTon; ?>" maxlength="99999" >  
										</td>
										<td>
										...
										<td><input type="text" class="form-control Loads" id="Loads<?php echo $record->BookingID; ?>" readonly style="text-align:right" value="<?php echo $record->Loads;  ?>"  name="Loads[<?php echo $record->BookingID; ?>]" required="required"    > 
