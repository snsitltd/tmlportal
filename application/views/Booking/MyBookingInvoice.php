<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i> My Booking Invoice </h1>    </section> 
			...
			<div class="col-md-12">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs"> 
						<li class="active"><a href="#all" data-toggle="tab" aria-expanded="true" >My Invoices</a></li>         
						<li class=""><a href="<?php echo base_url('BookingInvoice'); ?>"  aria-expanded="false" >All Invoices </a></li>
					</ul> 
							...
							<div class="row">
								...
								<div class="box">
									<div class="box-header">
										<h3 class="box-title">My Booking Invoice  </h3>
									</div> 
									<div class="box-body" >
...
<script type="text/javascript" language="javascript" >
	...
	$(document).ready(function() { 
		...
		var dataTable = $('#Invoice').DataTable({
			...
			"ajax":{
				url : "<?php echo site_url('AjaxMyInvoiceList') ?>", // json datasource
