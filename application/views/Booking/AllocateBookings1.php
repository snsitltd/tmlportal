...
<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i> Loads/Lorry Booking Allocation DEMO  </h1>    </section> 
	...
	<div id="example2_wrapper" style="min-height:500px" class="dataTables_wrapper form-inline dt-bootstrap table-responsive"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12">                  
		  ...
		  <thead>
			...
			<tr  class="<?php echo $cls1; ?>" >
				...
				<input type="hidden" name= "MID<?php echo $record->BookingDateID; ?>" id= "MID<?php echo $record->BookingDateID; ?>"  value="<?php echo $record->MaterialID; ?>" >
				<a class="btn btn-sm  btn-info Allocate" herf="#" data-BookingNo="<?php echo $record->BookingID; ?>"  data-PendingLoad="<?php echo $pLoads; ?>"  data-LoadType="<?php echo $record->LoadType; ?>"  data-BookingDate="<?php echo $record->BookingDateTime; ?>"  data-BookingDateID="<?php echo $record->BookingDateID; ?>"   title="Allocate Booking"><i class="fa fa-check"></i> </a>
				<a class="btn btn-sm btn-danger DeleteBooking"  data-BookingDateID="<?php echo $record->BookingDateID; ?>"  href="#" title="Delete"><i class="fa fa-trash"></i></a>  </div>   
				</td>
			</tr>
			<?php
					}
	...
	$(document).ready(function() { 
		...
		var dataTable = $('#ticket-grid4').DataTable({
			...
			createdRow: function (row, data, dataIndex) {  
				...
				$(row).find("td:eq(0)").html('<a class="ShowLoads" data-BookingNo="'+data["BookingID"]+'" herf="#" >'+data["BookingID"]+'</a>'); 
