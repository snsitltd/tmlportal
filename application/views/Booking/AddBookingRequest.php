...
<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="fa fa-users"></i> Add Booking </h1>
	</section>
			...
			<div class="col-md-12">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						<li class="active"><a href="#AddBooking1" data-toggle="tab" aria-expanded="true">Add Booking
							</a></li>
						<li class=""><a href="<?php echo base_url('AddBookingRequestTonnage'); ?>"
								aria-expanded="false">Add Tonnage Booking</a></li>
								...
								<div class="col-md-12">
									...
									<div class="box box-primary">
										...
										<form id="AddBooking" name="AddBooking"
											action="<?php echo base_url('AddBookingRequest'); ?>" autocomplete="off"
											...
											<div class="box-body">
												<div class="col-md-6">
													...
													<div class="row">
														<div class="col-md-4">
															<label for="TypeOfCustomer"> PMT: </label> <span
																id="PType">N/A</span>
														</div>
														<div class="col-md-4">
															<label for="CreditLimit"> C/L: </label> <span
																id="CreditLimit">N/A</span>
														</div>
														<div class="col-md-4">
															<label for="Outstanding">O/S: </label> <span
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<input type="text" class="form-control"
																	id="ContactMobile" autocomplete="off"
																	required="required"
									...
									<div class="form-group">
										...
										<input type="text" class="form-control " id="PurchaseOrderNumber" value="<?php //echo set_value('PurchaseOrderNumber'); 
																...
																<tr id="1">
																	...
																	<td>
																		<select class="form-control LorryType"
																			id="LorryType1" required="required"
																			name="LorryType[]" data-live-search="true">
																	...
																	<td>
																		<select class="form-control Loads" id="Loads1"
																			name="Loads[]" required="required"
																			data-live-search="true">
																			<?php for ($i = 1; $i <= 100; $i++) { ?>
																				<option value="<?php echo $i; ?>" <?php if ($i == set_value('Loads')) { ?> selected
													...
													<div class="row">
														<div class="col-md-3">
															<div class="form-group">
																...
																<!-- <input type="text" class="form-control " id="PaymentType" value="<?php //echo set_value('PaymentType'); 
																																		?>" name="PaymentType" maxlength="20" >
										<i id='pdate'></i> -->
															</div>
														</div>
													</div>
...
<script type="text/javascript" language="javascript">
	$(document).ready(function() {
		...
		$('#addBtn').on('click', function() {
			...
			var LRTOptions = '<option required value="" >Select</option><option value="1" >Tipper</option><option value="2" >Grab</option><option value="3" >Bin</option>';
			$("#LorryType" + rowIdx).html(LRTOptions).selectpicker('refresh');

			var LO = '';
			for (i = 1; i <= 100; i++) {
				LO += '<option value="' + i + '"  >' + i + '</option>';
			}
	...
	$(this).datepicker({
		format: 'dd/mm/yyyy',
		daysOfWeekDisabled: [0],  // Optional: disables Sundays
		multidate: 6,
		closeOnDateSelect: true,
		autoclose: true,
		todayHighlight: true
...
// });
		...
		$("body").on("change", ".Price", function() {
			...
			for (var i = 0; i < TotalHidden.length; i++) {
				if (TotalHidden[i].value == "") {
					TotalHidden[i].value = 0;
				}
				...
				jQuery.ajax({
					...
					if (data.status == false) {
						...
						for (var i = 0; i < data.material_list.length; i++) {
							if (data.material_list[i].Status == 1) {
								sty = 'style="background-color:#dd4b39;color:white;font-weight: bold;"'
							} else {
								sty = '';
							}
