            ...
            <div class="col-md-12">
              <!-- general form elements -->    
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url('EditLorry/'.$driver['LorryID'])?>" method="post" data-parsley-validate > 
						<input type="hidden" name="LorryID" value="<?php echo $driver['LorryID'];?>">  
                        <div class="box-body">  
							<div class="row">
                               <div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="integer">Lorry No </label>
                                          <input name="LorryNo" id="LorryNo" required  readonly type="Number" min="1" max="200"  value="<?php echo $driver['LorryNo']; ?>"  class="form-control col-md-7 col-xs-12"  placeholder="Lorry No" maxlength="3" > 										 
                                    </div> 
                                </div>  
                                <div class="col-md-3">                                
                                    <div class="form-group">
								...
								<div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="MacAddress">MAC Address</label>
                                         <input name="MacAddress" type="text"  class="form-control col-md-7 col-xs-12"  value="<?php echo $driver['MacAddress']; ?>" placeholder="MAC Address" id="MacAddress" >
