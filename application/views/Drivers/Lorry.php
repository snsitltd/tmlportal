        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a href="<?php echo base_url("AddLorry"); ?>" class="btn btn-primary" data-toggle="modal"  >  <i class="fa fa-plus"></i> Add New  </a>
                </div>
            </div>
        </div>
        <div class="row">
	...
	$(document).ready(function() {
		...
		var dataTable = $('#ticket-grid').DataTable({
			...
			createdRow: function (row, data, dataIndex) {   
				...
				$(row).find("td:eq(-1)").html(' <a class="btn btn-sm btn-info" href="'+baseURL+'EditLorry/'+data["LorryID"]+'" title="Update Lorry  "> <i class="fa fa-pencil"></i></a> <a class="btn btn-sm btn-danger deleteDriver" href="#" data-LorryNo="'+data["LorryNo"]+'" title="Delete"><i class="fa fa-trash"></i></a>'); 
			}
		});
