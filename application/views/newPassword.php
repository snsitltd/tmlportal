...
<html>
  ...
  <body class="login-page">
    <div class="login-box">
	  ...
	  <p class="login-box-msg"><a href="#"><img src="<?php echo site_url().'assets/Uploads/Logo/'.WEB_PAGE_LOGO?>" alt="<?php echo WEB_PAGE_TITLE; ?>" width="100" ></a><br><b>Reset Password</b></p>  
