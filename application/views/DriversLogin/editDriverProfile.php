							...
							<div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="UserName" class="form-control required" value="<?php echo $driver['UserName']; ?>" id="UserName" name="UserName" maxlength="128">
                                    </div> 
                                </div> 
                            </div> 
							<div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Email Address"  class="form-control" value="<?php echo $driver['Email']; ?>" id="Email" name="Email" >
                                    </div> 
                                </div> 
                            </div>
							<div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Mobile No"  class="form-control required" value="<?php echo $driver['MobileNo']; ?>" id="MobileNo" name="MobileNo" maxlength="11" minlength="11">
                                    </div> 
                                </div> 
                            </div>
							<!--<div class="row"> 
