          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <?php $this->load->helper("form"); ?>
                    <form role="form" id="contactsubmit" action="<?php echo base_url() ?>addnewcontactsubmit" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required digits" id="PhoneNumber" value="<?php echo set_value('PhoneNumber'); ?>" name="PhoneNumber" maxlength="10" minlength="10">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required digits" id="PhoneExtension" value="<?php echo set_value('PhoneExtension'); ?>" name="PhoneExtension" maxlength="10">
                                    </div>
                                </div>
                             ...
                             <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required digits" id="MobileNumber" value="<?php echo set_value('MobileNumber'); ?>" name="MobileNumber" maxlength="10" minlength="10">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control required email" id="EmailAddress" value="<?php echo set_value('EmailAddress'); ?>" name="EmailAddress" maxlength="100">
                                    </div>
                                </div>                           
                            ...
                            <div class="row">                               
                               ...
                               <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="Position" value="<?php echo set_value('Position'); ?>" name="Position" maxlength="100">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Department" value="<?php echo set_value('Department'); ?>" name="Department" maxlength="100">
                                    </div>
                                </div>
                ...
                <div class="row">
                                ...
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required CompanyName" value="<?php echo set_value('CompanyName'); ?>" id="CompanyName" name="CompanyName" maxlength="128">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required email EmailID" id="EmailID" value="<?php echo set_value('EmailID'); ?>" name="EmailID" maxlength="128">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required digits Phone1" id="Phone1" value="<?php echo set_value('Phone1'); ?>" name="Phone1" maxlength="10">
                                    </div>
                                </div>
                            ...
                            <div class="row">                               
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control digits Phone2" id="Phone2" value="<?php echo set_value('Phone2'); ?>" name="Phone2" maxlength="10">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required Fax" id="Fax" value="<?php echo set_value('Fax'); ?>" name="Fax" maxlength="20">
                                    </div>
                                </div>
                            ...
                            <div class="row">                               
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control Website" id="Website" value="<?php echo set_value('Website'); ?>" name="Website" maxlength="100">
                                    </div>
                                </div>  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control Country required" id="Country" name="Country">
                                            ...
                                            if(!empty($country))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $rl->country_code ?>"><?php echo $rl->country_name ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
