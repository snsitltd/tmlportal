...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Thames Materials | Admin System Log in</title>
  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
		<p class="login-box-msg"><a href="#"><img src="<?php echo site_url().'assets/Uploads/Logo/'.WEB_PAGE_LOGO?>" alt="<?php echo WEB_PAGE_TITLE; ?>" width="100" ></a><br>Forgot Password</p> 
