<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i> Deleted Tickets Management <small>Add, Edit, Delete</small>   </h1>    </section> 
            ...
            <div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><b>Deleted Tickets List</b></h3> 
...
var GetTableMetaApiEndpoint = 'DeletedTicketsTableMeta';//Endpoint returning Table Metadata 
var GetTableDataApiEndpoint = 'AJAXDeleteTickets';//Endpoint processing and return Table Data
	...
	$(document).ready(function() {
		...
		/*var dataTable = $('#ticket-grid').DataTable({
			...
			"columns": [
				...
				{ "data": "delete_notes", "name": "delete_notes" }, 
				{ "data": null } 
			  ],
			"aoColumnDefs": [ { "bSearchable": false, "aTargets": [ -1 ] } ], 
			"ajax":{
				url : "<?php echo site_url('AJAXDeleteTickets') ?>", // json datasource
		...
		jQuery(document).on("click", ".restoreTicket", function(){
			var TicketNo = $(this).attr("data-TicketNo"),
				hitURL = baseURL + "restoreTicket",
				currentRow = $(this);	 
			var confirmation = confirm("Are you sure you want to restore Ticket?", ""); 
			if(confirmation!=null){ 
				if(confirmation!=""){ 
					...
					data : { 'TicketNo' : TicketNo } 
						...
						if(data.status != "") { alert("Record successfully Restored"); }
						else{ alert("Record Restoration failed"); } 
					}); 				
				}
			}
		}); 
