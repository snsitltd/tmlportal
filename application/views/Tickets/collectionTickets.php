...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Add Collection Ticket
            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form id="collectionTicketssubmit" name="collectionTicketssubmit"  action="<?php echo base_url('AddCollectionTicketAJAX') ?>" method="post" role="form"  >
                    <div class="box-body">
                        <div class="col-md-6">   
                            <div class="row"> 
                                 <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select_opportunity" id="OpportunityID" name="OpportunityID" required="required"  data-live-search="true" aria-required="true">
                            ...
                            <div class="row">                               
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="DescriptionofMaterial" name="DescriptionofMaterial" required="required"  data-live-search="true" aria-required="true">
                                        <?php 
							...
							<div class="row">
                                <div class="col-md-12">
                                    <div class="form-group"> 
										...
										<input type="submit" name="hold" class="btn btn-warning" value="HOLD" style="float:right;margin-right:5px;"  /> 
