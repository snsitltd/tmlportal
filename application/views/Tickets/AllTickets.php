...
<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i> Tickets Management <small>Add, Edit, Delete</small>   <a class="btn btn-danger" href="<?php echo base_url(); ?>AllTicketsArchived"  style="float:right;margin: 6px ">  Archived Tickets</a> </h1>    </section> 
            ...
            <div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><b>All Tickets List</b></h3>  
...
var GetTableMetaApiEndpoint = 'AllTicketsTableMeta';//Endpoint returning Table Metadata 
var GetTableDataApiEndpoint = 'AllTicketsAJAX';//Endpoint processing and return Table Data
