 ...
 <div class="content-wrapper">
 	<section class="content-header">
 		<h1> <i class="fa fa-users"></i> Tickets Management <small>Add, Edit, Delete</small> <a class="btn btn-danger" href="<?php echo base_url(); ?>AllTicketsArchived" style="float:right;margin: 6px "> Archived Tickets</a> </h1>
 	</section>
