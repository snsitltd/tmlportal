...
<link rel="stylesheet" href="<?php echo base_url('docs/css/signature-pad.css'); ?>">
  <div class="content-wrapper"> 
    <section class="content-header"><h1><i class="fa fa-users"></i> Edit InCompleted Ticket </h1></section> 
            ...
            <div class="col-md-12"> 
                <div class="box box-primary">
                    <div class="box-header">
                     ...
                     <form role="form" id="EditInCompleted" name="EditInCompleted" action="<?php echo base_url("EditInCompletedAJAX"); ?>" method="post"  >  
							...
							<div class="row">   
								<div class="col-md-4" > 
									<div class="form-group">
										<label for="date-time">Ticket Date Time <span class="required">*</span></label>
										<div class="input-group date">
											<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
											<input type="text" class="form-control required" id="TicketDate" value="<?php echo $tickets['TicketDate1']; ?>" name="TicketDate" maxlength="65">
										</div>
									</div> 
								</div>	  
							</div>	  
                         ...
                         <div class="row">
                                       ...
                                       <select class="form-control" id="LorryNo" name="LorryNo"  aria-required="true" data-live-search="true" >
                                           <?php  
                                                foreach ($Lorry as $key => $value) {
                                                  ...
                                                  echo  "<option value='".$value->LorryNo."' ".$selected." > ".$value->LorryNo." | ".$value->RegNumber." </option>";
                                                }
                                           ?>                                    
                                        </select><div ></div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" readonly id="DriverName" value="<?php echo $tickets['DriverName']; ?>" name="DriverName" maxlength="50"  >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="VechicleRegNo" value="<?php echo $tickets['RegNumber']; ?>" name="VechicleRegNo" maxlength="100"  readonly >
                                    </div>
                                </div>
