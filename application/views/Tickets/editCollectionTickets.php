...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-users"></i> Edit Collection Ticket
                        ...
                        <div class="col-md-6">                              
                            <div class="row"> 
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="Conveyance">OrderNo</label>
                                        <input type="text" class="form-control" id="OrderNo" value="<?php echo $tickets['OrderNo']; ?>" name="OrderNo">
                                    </div>
                                </div>
...
?>
                         ...
                         <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group"> 
                                       ...
                                       <select class="form-control" id="LorryNo" name="LorryNo" data-live-search="true"   aria-required="true">
                                           <?php 
                        ...
                        <input type="hidden" name="TicketType" id="TicketType" value="Collection">
