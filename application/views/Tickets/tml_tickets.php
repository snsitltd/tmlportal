<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i> TML Tickets Management <small>Add, Edit, Delete</small>  <a class="btn btn-success" href="<?php echo base_url(); ?>TMLTicketsArchived"  style="float:right;margin: 6px "> Archived TML Tickets</a> </h1>    </section> 
            ...
            <div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><b>TML Tickets List</b></h3>
...
var GetTableMetaApiEndpoint = 'TMLTicketsTableMeta';//Endpoint returning Table Metadata 
var GetTableDataApiEndpoint = 'AJAXTmlTickets';//Endpoint processing and return Table Data
	...
	$(document).ready(function() {
		...
		/*var dataTable = $('#ticket-grid').DataTable({
			...
			"ajax":{
				url : "<?php echo site_url('AJAXTmlTickets') ?>", // json datasource
