            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="EditInTicket" name="EditInTicket" action="<?php echo base_url("EditTicketAJAX"); ?>" method="post"  >  
                            ...
                            <div class="row">  
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Conveyance" required="required"  value="<?php echo $tickets['Conveyance']; ?>" name="Conveyance">
                                    </div>
                                </div> 
								<div class="col-md-6"> 
										<div class="form-group">
										...
										<?php if($tickets['LoadID']==0){ ?>
											<button type="button" class="btn btn-sm btn-warning LinkConveyance" data-TicketNo = "<?php echo $tickets['TicketNo']; ?>"  title="Link Conveyance" style="font-size:14px" ><i class="fa fa-search"></i> <b>Link Conveyance</b> </button>										 
										<?php } ?>
                                        </div> 
                                    </div> 
                                </div>                               
							...
							<div class="row">        
                                <div class="col-md-12">
									<div class="form-group">
                                        ...
                                        <div class="checkbox"> 
											<label> <input type="radio" class="LorryType" name="LorryType" id="LorryType" value="1"  <?php if($LorryType==1){ ?> checked <?php } ?> > Tipper  </label>
											<label> <input type="radio" class="LorryType"  name="LorryType" id="LorryType"  value="2"  <?php if($LorryType==2){ ?> checked <?php } ?>> Grab </label>
											<label> <input type="radio" class="LorryType"  name="LorryType" id="LorryType"  value="3"  <?php if($LorryType==3){ ?> checked <?php } ?> > Bin </label>
                                        </div> 
                         ...
                         <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
										...
										<input type="text" class="form-control required EditVechicleRegNo VechicleRegNo" id="VechicleRegNo" value="<?php echo $tickets['RegNumber']; ?>" name="VechicleRegNo" maxlength="100"  >
							...
							<div class="row">
                                <div class="col-md-12">
                                    <div class="form-group"> 
										...
										<input type="submit"  name="submit" id="submit"   class="btn btn-primary" style="float:right; "  value="Submit" /> 
										...
										<input type="hidden" name="driversignature" class="required" id="driversignature" value="<?php echo $tickets['driversignature']; ?>" >
										<div id="driverimage"><?php if($tickets['driversignature']!=""){ ?>
										<img src="<?php echo $tickets['driversignature']; ?>" height="400px" width="700px"><?php } ?></div> 
                                    </div>
                                </div>                           
                            </div>   
                        </div> 
			...
			var LoadID = $('#LoadID').val(),    
				...
				if(LoadID > 0 ){  
					...
					$.ajax({
						...
						dataType : "json",
						url : hitURL1,
						data : { 'LoadID' : LoadID, 'TicketNo' : TicketNo, 'Vat' : Vat  , 'VatAmount' : VatAmount  , 
