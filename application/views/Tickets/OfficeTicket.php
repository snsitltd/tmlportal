...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-users"></i> Add Office ( GAP ) Ticket <small>Add Office ( GAP ) Ticket</small>
      </h1>
    </section>  
            ...
            <div class="col-md-12">
              <!-- general form elements --> 
                <div class="box box-primary">
                    ...
                    <form id="addOfficeTicketsSubmit" name="addOfficeTicketsSubmit"  action="<?php echo base_url("AddOfficeTicketAJAX") ?>" method="post" role="form" > 
					<input type="hidden" name="TicketNumber" id="TicketNumber" value="<?php echo $TicketNumber; ?>"  >
                        <div class="box-body">
                        <div class="col-md-6">     
							<div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="Conveyance">Ticket Number <span class="required">*</span> </label>
                                        <input type="text" class="form-control"  value="<?php echo $TicketNumber; ?>" readonly style="width:130px" >   
                                    </div>
                                </div>                         
								<div class="col-md-4">
                                    <div class="form-group">
                                        <label for="TicketGap"> &nbsp</label> 
										<input type="text" class="form-control" required name="TicketGap" id="TicketGap" value="<?php echo set_value('TicketGap'); ?>" style="width:50px"  maxlength="3"  >  
										<div id="dup" style="color:red"></div>
                                    </div>
                                </div>                         
								<div class="col-md-6">
                                    <div class="form-group">
                                        <label for="date-time">Ticket Type <span class="required">*</span></label>
                                        <select class="form-control" id="TypeOfTicket" name="TypeOfTicket" required="required"  >
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        <label> <input type="checkbox" name="is_tml" value="1" checked > Is TML Ticket  </label>
                                        </div>
                           ...
                           <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group"> 
                                        ...
                                        <select class="form-control  required" id="CompanyID" name="CompanyID" required="required" data-live-search="true"   >
                                        <?php 
                                        echo '<option value="0">-- ADD COMPANY --</option>';
                                        foreach ($company_list as $key => $value) {
											if($value['CompanyID'] != $COMID['CompanyID']){
                            ...
                            <div class="row">
								...
								<div class="col-md-4" id="hide2" style="display:none" >
										<div class="form-group">	
                            ...
                            <div class="row">  
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="SiteAddress" value="<?php echo set_value('SiteAddress'); ?>" name="SiteAddress" maxlength="100" readonly>
                                    </div>
                                </div>                                   
                            </div>  
                            <div class="row">  
                            ...
                            <div class="row">    
                                ...
                                <div class="col-md-4" >
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="SicCode" value="<?php echo set_value('SicCode'); ?>" name="SicCode" maxlength="100" readonly>
                                    </div>
                                </div> 
                         ...
                         <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                       ...
                                       <select class="form-control" id="LorryNo" name="LorryNo" required="required"  data-live-search="true" >
                                            <?php   
                            ...
                            <div class="row">   
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="GrossWeight" onKeyPress="if(this.value.length==5) return false;"  value="<?php echo set_value('GrossWeight'); ?>" name="GrossWeight" maxlength="5"   >
                                    </div>
                                </div> 
							...
							<div class="row">
                                <div class="col-md-12">
                                    <div class="form-group"> 
										...
										<input type="submit" name="submit" class="btn btn-primary addsubmit" style="float:right; "  value="Submit" /> 
										...
										<input type="hidden" name="driversignature"  required  id="driversignature" value="" >
