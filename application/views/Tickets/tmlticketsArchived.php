<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i> TML Tickets Management  (Archived) <a class="btn btn-success" href="<?php echo base_url(); ?>TML-Tickets"  style="float:right;margin: 6px "> Recent TML Tickets</a>   </h1>    </section> 
...
var GetTableMetaApiEndpoint = 'TMLTicketsTableMetaArchived';//Endpoint returning Table Metadata 
var GetTableDataApiEndpoint = 'AJAXTmlTicketsArchived';//Endpoint processing and return Table Data
