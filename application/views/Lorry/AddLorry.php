                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="integer">Lorry No <span class="required" aria-required="true">*</span></label>
                                          <input name="LorryNo" id="LorryNo" required type="Number" min="1" max="5000" class="form-control col-md-7 col-xs-12"  placeholder="Lorry No" maxlength="4" > 										 
                                    </div> 
                                </div>  
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="TruckNoOfAxle">Truck No Of Axle  </label>
                                         <input name="TruckNoOfAxle"  class="form-control col-md-7 col-xs-12"  placeholder="Truck No Of Axle" >
                                    </div> 
                                </div> 
                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="Identifier">Identifier </label>
                                         <input name="Identifier" type="text"  class="form-control col-md-7 col-xs-12"  placeholder="Identifier" id="Identifier" >
                                    </div> 
                                </div> 
								<div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="IMEI">IMEI </label>
                                         <input name="IMEI" type="text"  class="form-control col-md-7 col-xs-12"  placeholder="IMEI" id="IMEI" > 
                                    </div> 
                                </div> 
                            </div>	
							<br>
                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="SerialNo">SerialNo</label>
                                         <input name="SerialNo" type="text"  class="form-control col-md-7 col-xs-12"  placeholder="SerialNo" id="SerialNo" >
                                    </div> 
                                </div>  
                            </div>	
							<br> -->
