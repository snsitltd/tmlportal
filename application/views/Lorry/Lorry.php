<div class="content-wrapper"> 
	...
	<a href="<?php echo base_url("LorryOthers"); ?>" class="btn btn-danger"   style="float:right"  >  Others Lorry  </a>
	</h1> 
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="box-header">
              <h3 class="box-title">Thames Lorry List   </h3>
            ...
            <div class="box-body">
              <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12">                  
                  ...
                  <thead>
                    <tr> 
                        <th width="50" align="right">LorryNo</th>   
                        <th width="100">Reg Number</th>   
                        <th width="70" align="right">Tare</th>  
                        <th >Driver Name</th>   
						<th width="70" >AndroidID</th>       
						<th width="70" >MacAddress</th>       
						<th width="50" >AppUser</th>     
						<th width="50" >AppAssign</th>     
	...
	$(document).ready(function() {
		...
		var dataTable = $('#ticket-grid').DataTable({
			...
			createdRow: function (row, data, dataIndex) {   
				var AppUser = ''; var AppAssign = '';
				if(data["AppUser"]==0){ AppUser = '<span class="label label-success " >Yes</span>'; }else{ AppUser = '<span class="label label-danger " >NO</span>'; }
				if(data["is_lorry_assigned"]==1){ AppAssign = '<span class="label label-success " >Yes</span>'; }else{ AppAssign = '<span class="label label-danger " >NO</span>'; }
				$(row).find("td:eq(6)").html(AppUser);  
				$(row).find("td:eq(7)").html(AppAssign);  
				...
				$(row).find("td:eq(-1)").html(' <a class="btn btn-sm btn-info" href="'+baseURL+'EditLorry/'+data["LorryNo"]+'" title="Update Lorry  "> <i class="fa fa-pencil"></i></a>'); 
			}
		});
