                               ...
                               <div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="integer">Lorry No </label>
                                          <input name="LorryNo" id="LorryNo" required  readonly type="Number" min="1" max="15000"  value="<?php echo $driver['LorryNo']; ?>"  class="form-control col-md-7 col-xs-12"  placeholder="Lorry No" maxlength="4" > 										 
                                    </div> 
                                </div>  
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="RegNumber">Reg Number<span class="required" aria-required="true">*</span></label>
                                         <input name="RegNumber" value="<?php echo $driver['RegNumber']; ?>"   <?php if($driver['is_lorry_assigned']=='1'){ ?> readonly <?php } ?>  class="form-control col-md-7 col-xs-12"  placeholder="RegNumber" >
                                    </div> 
                                </div> 
                            </div>
							<div class="row">
                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        ...
                                        <input id="Haulier" class="form-control col-md-7 col-xs-12" readonly
                                          name="Haulier" placeholder="Haulier"  value="<?php echo $driver['Haulier']; ?>"  type="text">
                                    </div> 
                                </div> 
                            </div>  
							<br>
                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="TruckNoOfAxle">Truck No of Axle  </label>
                                         <input name="TruckNoOfAxle" value="<?php echo $driver['TruckNoOfAxle']; ?>"   class="form-control col-md-7 col-xs-12"  placeholder="Truck No Of Axle" >
                                    </div> 
                                </div> 
                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="DriverName">Driver Name </label>
                                         <input name="DriverName" type="text"  class="form-control col-md-7 col-xs-12"  value="<?php echo $driver['DriverName']; ?>"   placeholder="Driver Name" id="DriverName" >
                                    </div> 
                                </div> 
								<div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="MacAddress">MAC Address</label>
                                         <input name="MacAddress" type="text"  class="form-control col-md-7 col-xs-12"  <?php if($driver['is_lorry_assigned']=='1'){ ?> readonly <?php } ?>  value="<?php echo $driver['MacAddress']; ?>" placeholder="MAC Address" id="MacAddress" >
                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="Identifier">Identifier </label>
                                         <input name="Identifier" type="text"  class="form-control col-md-7 col-xs-12"  <?php if($driver['is_lorry_assigned']=='1'){ ?> readonly <?php } ?>  value="<?php echo $driver['Identifier']; ?>"   placeholder="Identifier" id="Identifier" >
                                    </div> 
                                </div> 
								<div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="IMEI">IMEI </label>
                                         <input name="IMEI" type="text"  class="form-control col-md-7 col-xs-12"   value="<?php echo $driver['IMEI']; ?>" placeholder="IMEI" id="IMEI" > 
                                    </div> 
                                </div> 
                            </div>	
							<br>
                                ...
                                <div class="col-md-3">                                
                                    <div class="form-group">
                                        <label for="SerialNo">SerialNo</label>
                                         <input name="SerialNo" type="text"  class="form-control col-md-7 col-xs-12"   value="<?php echo $driver['SerialNo']; ?>"   placeholder="SerialNo" id="SerialNo" >
                                    </div> 
                                </div>  
                            </div>	
							<br>
							...
							<div class="row"> 
                                <div class="col-md-3">                                
                                    <div class="form-group">
										...
										<select class="form-control" id="is_lorry_assigned" name="is_lorry_assigned" data-live-search="true"  required  > 
