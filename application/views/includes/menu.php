...
$bookings = array("bookings","bookingallocate","allocateddrivers", "addbooking", "editbooking", "loads","cloads", "message", "chatmessage", "driverloads","nonappsloads");
...
$reports = array("ticketreports", "materialreports","tmlreports","eareports","tippedinreports","ticketpaymentreports","materialreports","executivesummarydriverlist");
        ...
        <ul class="sidebar-menu">
			...
			<li class="treeview <?php if (in_array($active_menu, $bookings)) echo 'active menu-open' ?>">
                ...
                <ul class="treeview-menu" style="<?php if (in_array($active_menu, $bookings)) echo ''; else echo 'display: none;' ?>">
					...
					<li class="<?php if ('chatmessage' == $active_menu ) echo 'active'; ?>"><a href="<?php echo base_url('AddChatMessage'); ?>"><i class="fa fa-circle-o"></i>All Chat Messages</a></li>  
            ...
            <li class="treeview <?php if (in_array($active_menu, $reports)) echo 'active menu-open' ?>">
                ...
                <ul class="treeview-menu" style="<?php if (in_array($active_menu, $reports)) echo ''; else echo 'display: none;' ?>">
					...
					<li class="<?php if ('executivesummarydriverlist' == $active_menu) echo 'active'; ?>"><a href="<?php echo base_url('ExecutiveSummaryDriverList'); ?>"><i class="fa fa-circle-o"></i> Load/Driver</a></li> 
                </ul>
            </li>
