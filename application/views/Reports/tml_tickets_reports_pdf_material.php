...
<h1 align="center"><?php echo $title; ?></h1>
	...
	if(!empty($ticketsRecords)){
		...
		foreach($ticketsRecords as $key=>$record){  
			...
			<?php if($j!=0){ ?> 
					<tr> 
						<td align="right"  height="10"  colspan="7" width="<?php //echo $con_width1; ?>"   style="border: 1px solid #F2F2F2 ;background-color:#F2F2F2"><b>Loads </b></td>
						<td align="right" width="70" style="border: 1px solid #F2F2F2 ;background-color:#F2F2F2"><b><?php echo $loads2; //echo $record->mCount; ?></b> </td>
						<td align="right" width="70" style="border: 1px solid #F2F2F2 ;background-color:#F2F2F2"><b> Net</b></td>
						<td align="right" width="70" style="border: 1px solid #F2F2F2 ;background-color:#F2F2F2"><b><?php echo round($net2); //echo round($record->netTotal); ?></b>  </td>
					</tr> 				
				</tbody>
				</table>  
			...
			<tbody> 
				<tr><td colspan="10" style="border: 1px solid #000000 ;background-color:#F2F2F2" height="30"><b>Material: </b><?php echo $record->MaterialName; ?> </td></tr>  
			</tbody>
			</table> 	
			<?php  } ?> 
			<?php if($c1 != $c ){   $c1=$record->CompanyID;    $loads = 0; $loads2 = 0;  $net2 = 0;  $j=0;    ?>   
				<table style="font-size:12px"  width = "1000" cellpadding="5"  autosize="1" > 
				<tbody>
					<tr><td style="border: 1px solid #F2F2F2 ;background-color:#F2F2F2" colspan="10" height="30"><b>Company: </b><?php echo $record->CompanyName; ?></td></tr>  
					<tr> 
						...
						<th width="70" align="left">OrdNo</th>
			...
			<?php } ?> 
					...
					<tr> 
						...
						<td style="border: 1px solid #d3d3d3 ;"   ><?php echo trim($record->OrderNo) ?></td>
			...
			<?php $loads = $loads+1;  $loads1 = $loads1+1;  $loads2 = $loads2+1;  $j = $j+1; $net1 = $net1 + $record->Net; $net2 = $net2 + $record->Net;  ?>  
			<?php if($i== $count-1){ ?>
					<tr> 
						<td align="right" colspan="6" style="border: 1px solid #F2F2F2 ;background-color:#F2F2F2"><b>Loads </b></td>
						<td align="right"  width="70" style="border: 1px solid #F2F2F2 ;background-color:#F2F2F2"><b><?php echo $loads2; ?> <?php //echo $record->mCount; ?></b> </td>
						<td align="right" width="70" style="border: 1px solid #F2F2F2 ;background-color:#F2F2F2"><b> Net </b></td>
						<td align="right" width="70" style="border: 1px solid #F2F2F2 ;background-color:#F2F2F2"><b><?php echo round($net2); ?> <?php //echo round($record->netTotal); ?></b>  </td>
					</tr> 
