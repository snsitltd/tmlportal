		...
		foreach($ticketsRecords as $key=>$record){ 
			...
			<?php if($c1 != $c || $m1 != $m ){	 ?>    
				<?php if($j!=0){ ?>
						...
						<tr> 
							<td align="right" colspan="7" style="border: 1px solid #F2F2F2 ;background-color:#F2F2F2"><b>Loads </b></td>
			...
			<?php if($c1 != $c ){	 ?>   
				...
				<table style="font-size:12px" width = "1007" cellpadding="5"  autosize="1" > 
				<tbody> 
					<tr><td style="border: 1px solid #000000 ;background-color:#F2F2F2" colspan="10" height="30"><b>Company: </b><?php echo $record->CompanyName; ?></td></tr>   
				</tbody>
				</table> 
			<?php  } // End  if($c1 != $c ) ?> 
				<?php if($m1 != $m ){  ?> 
				
				<?php $m1=$record->MaterialID;   $loads = 0; $loads2 = 0;  $net2 = 0;  $j=0;   ?>   
				
				
					<table style="font-size:12px"  width = "1000" cellpadding="5"  autosize="1" > 
					<tbody>
						<tr><td style="border: 1px solid #F2F2F2 ;background-color:#F2F2F2" colspan="10"  height="30"><b>Material: </b><?php echo $record->MaterialName; ?></td></tr> 
						<tr> 
			...
			<?php $loads = $loads+1;  $loads1 = $loads1+1; $loads2 = $loads2+1; $net1 = $net1 + $record->Net; $net2 = $net2 + $record->Net; $j = $j+1; ?>  
			<?php if($i== $count-1){ ?> 
					<tr> 
