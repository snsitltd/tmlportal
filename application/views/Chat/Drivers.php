<div class="content-wrapper"> 
    <section class="content-header"> <h1> <i class="fa fa-users"></i>All Chat Messages </h1>    </section> 
			   ...
			   <div class="row">
					<div class="col-xs-12 text-right">
						<div class="form-group"> 
							<a class="btn btn-info"  href="<?php echo base_url('AddChatMessage'); ?>" ><i class="fa fa-plus"></i> Send Messages</a>  
						</div> 
					</div>
				</div> 
				<div class="row">
								...
								<div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap table-responsive"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12">                  
									  ...
									  <thead>
										<tr> 
											...
											<th>Driver Name</th>     
											<th>Last Message </th>     
											<th width="100">Last Message DateTime </th>    
											<th width="60">Last Message Status</th>    
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#ticket-grid').DataTable({
			...
			"ajax":{
				url : "<?php echo site_url('ChatAjaxMessage') ?>", // json datasource
			...
			createdRow: function (row, data, dataIndex) { 
				...
				var status ='<a href="<?php echo site_url('ViewChat'); ?>?id='+data["driver_id"]+'&lorry_no='+data["LorryNo"]+'" class="btn btn-info">View Chat</a>';
