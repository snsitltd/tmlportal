		...
		public function tipticketopportunitynew_get()
{
    ...
    if (REST_Controller::TOKEKEYS != $token) {
        ...
        // ✅ JOIN query instead of foreach + inner query
        $this->db->select('o.*, t.TipRefNo');
        $this->db->from('tbl_opportunity_tip t');
        $this->db->join('tbl_opportunities o', 'o.OpportunityID = t.OpportunityID', 'inner');
        $this->db->where('t.TipID', $tipID);
