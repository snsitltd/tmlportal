...
class Tiptickets extends REST_Controller {
	...
	public function tipticketopportunity_get(){
		...
		if(REST_Controller::TOKEKEYS != $token){
			...
			/*$this->db->select('OpportunityID, TipRefNo');
			...
			$this->db->select(
                        'tbl_opportunity_tip.OpportunityID,
                        tbl_opportunity_tip.TipRefNo, 
                        ...
                        tbl_opportunities.opp_latlong_updated_at'
            );
			$this->db->from('tbl_opportunity_tip');
			$this->db->join('tbl_opportunities', 'tbl_opportunity_tip.OpportunityID = tbl_opportunities.OpportunityID');
			$this->db->where('tbl_opportunity_tip.TipID', $tipID);
			$this->db->group_by('tbl_opportunity_tip.OpportunityID');
			$this->db->order_by('tbl_opportunity_tip.TableID', 'ASC');
			$query = $this->db->get();
