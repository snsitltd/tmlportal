                ...
                if ($Load_status == 1) {
                    ...
                    if (empty($_FILES['Signature']['name']) and ($dataarr[0]->BookingType == 1 || $dataarr[0]->BookingType == 4) and !$wastedJourney) {
                        ...
                        if ($dataarr[0]->BookingType == 3) {
                            $ticketsInfo = array(
                                'TicketUniqueID' => $TicketUniqueID, 'LoadID' => $LoadID, 'TicketNumber' => $TicketNumber, 'TicketNumberUnique' => $TicketNumber,
                            ...
                            try { 
                                $this->db->insert('tbl_tickets',$ticketsInfo);
                                ...
                                $data[0]['duplicate_ticket_entry'] = true;
                            ...
                            if ($wastedJourney) {
                                ...
                                <div style="width:100%;margin-bottom: 0px;margin-top: 0px;font-size: 10px;" >	
                                    ...
                                    <div style="width:100%;float: left;" >   
                                        ...
                                        <b>Company Name: </b> ' . $dataarr[0]->CompanyName . ' <br>			
                                        <b>Site Address: </b> ' . $dataarr[0]->OpportunityName . '<br>		 		 		
                                        <b>Haulage Address: </b> ' . $tipadQRY['Street1'] . ' ' . $tipadQRY['Street2'] . ' ' . $tipadQRY['Town'] . ' ' . $tipadQRY['County'] . ' ' . $tipadQRY['PostCode'] . '<br>	
                                        <b>Permit Reference No: </b>' . $tipadQRY['PermitRefNo'] . ' <br/>
                        ...
                        if ($dataarr[0]->BookingType == 2) {
                            ...
                            if ($TipID == 1) {
                                ...
                                if (($queryss->num_rows() > 0) && !empty($LConveyanceNo)) {
                                    ...
                                    $ticketsInfo = array(
                                        'TicketUniqueID' => $TicketUniqueID, 'LoadID' => $NewLoadID, 'TicketNumber' => $TicketNumber, 'TicketNumberUnique' => $TicketNumber,
                                        'TicketDate' => date('Y-m-d H:i:s'),
