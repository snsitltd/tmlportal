        ...
        if(REST_Controller::TOKEKEYS != $token){
           ...
           if($user){
                ...
                if(!isset($result['LorryNo']) || empty($result['LorryNo'])){
                    ...
                    $update = $this->db->query("update tbl_drivers_logs set LogoutDateTIme = '$LogoutDateTIme' where DriverID = '$lorry_no' AND DriverLoginID = '$driver_id' order by LogID DESC");
