<?php
	...
	where tbl_booking_loads1.Status < '3' and DATE_FORMAT(tbl_booking_loads1.AllocatedDateTime ,'%Y-%m-%d') <= CURDATE() ";
	...
	echo "Date: ".date("d/m/Y ")." == Total Turnaround Jobs  Removed : ".$del."  <br> ";	 
